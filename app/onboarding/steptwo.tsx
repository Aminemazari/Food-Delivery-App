...
export default function Onboarding() {
  ...
  const handleClick = ()=>{ 
    router.push('/onboarding/steptree') 
  }
  return (
    <View style={styles.container}>
      <Image source={require("../../assets/images/Frame.png")} style={styles.imagePlaceholder} />
      
      <Text style={styles.title}>Free shipping on all orders</Text>
